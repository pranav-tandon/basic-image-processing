...
/**
 * This datatype represents an <strong>immutable</strong> Quadrilateral
 * in the positive quadrant of the 2D plane. These rectangles match
 * standard picture representations with the coordinate values for the
...
public class Quadrilateral  {
    ...
    */
     ...
     */
    public Quadrilateral (int _xTopLeft, int _yTopLeft, int _xBottomRight, int _yBottomRight) {
